...
const VideoInfo = ({ title, overview }) => {
  return (
    <div className="pt-32 w-full h-screen px-14 w-4/12 absolute bg-gradient-to-r from-black">
      <h1 className="text-5xl p-4 font-bold text-orange-600 bg-white bg-opacity-70 rounded-lg w-4/12">
        {title}
      </h1>
      <p className="my-5 font-semibold text-sm text-white w-4/12">{overview}</p>
      <div className="flex">
